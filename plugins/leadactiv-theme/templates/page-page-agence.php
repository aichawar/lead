...
<main class="page__agence container__xl">
<section class="ontainer__lg page__agence--header position-relative mb-0 mt-">
    <div class="page__agence--header--top bg-light-purple pt-0 pt-md-1 overflow-hidden">
        <div class="c h-100 d-flex ">
            <div class="row h-100  w-100">
                <div class=" px-5 col-md-8 py-md-3 d-flex flex-column justify-content-left">
                    <h2 class="big-title f-56 mb-4 content-mb-0 position-relative">
    ...
    <section class=" container__lg page__agence__content align-content-between align-items-stretch" >
        <?php if (count($blocs["lames_contenu"]) >= 1): ?>
            ...
            foreach (is_array($blocs["lames_contenu"]) ? $blocs["lames_contenu"] : [] as $bloc):
                ...
                <?php switch ($bloc['acf_fc_layout']):
                    ...
                    case 'lame_chiffres': ?>
                        <section class="page__home--chiffres text-white bg-dark-green">
...
<?php break; ?>
                    ...
                    <div class="container__lg py-3 py-md-5">
