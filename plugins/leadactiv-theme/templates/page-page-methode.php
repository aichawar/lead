...
<main class="page__methode container__xl">
    <section class="container__lg page__methode--header position-relative mb-0 mb-md-0 mt-lg-0">
        <div class="page__methode--header--top bg-deep-purple pt-0 pt-md-1 overflow-hidden">
            <div class=" h-100 d-flex px-md-5 py-md-5">
                <div class="row h-100 align-items-center py-lg-5 px-5">
                    ...
                    <div
                        class="offset-md-1 col-md-5 page__methode--header--top--img d-none d-md-block justify-content-center justify-content-md-start">
                        <?php if ($entete["image"]): ?>
...
foreach (is_array($blocs["lames_contenu"]) ? $blocs["lames_contenu"] : [] as $bloc):
    ...
    <?php switch ($bloc['acf_fc_layout']):
        case 'lame_fonctionnement': ?>
            <section class=" container__lg page__methode--fonctionnement my-5 pt-4" id="decouvrir">
                <div class="page__methode--fonctionnement--top pt-3 my-4" id="section-header">
                    <div class="text-center">
                        <div id="section-title">
                            <?php if ($bloc["etiquette"]): ?>
                                <h3 class="tag tag-big"><?php echo $bloc["etiquette"] ?></h3>
                            <?php endif; ?>
                ...
                <div class="page__methode--fonctionnement--bottom">
                    <div class="position-relative">
                        <div class=" pt-2 px-5 justify-content-center position-relative">
        ...
        <?php case 'lame_partenaires': ?>
            ...
            <?php break; ?>
        <?php case 'lame_faq': ?>
            <section class="page__methode--faq">
                <div class="">
